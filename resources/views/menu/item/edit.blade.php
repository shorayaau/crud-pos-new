                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('jenis_barang') is-invalid @enderror"
                                name="jenis_barang" value="{{ old('jenis_barang', $item->jenis_barang) }}">
                            @error('jenis_barang')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <td class="text-center">
                                <img src="{{ Storage::url('public/item/') . $item->gambar }}" class="rounded"
                                    style="width: 150px">
                            </td>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" id="deskripsi" cols="3" class="form-control @error('deskripsi') is-invalid @enderror"
                                value="{{ old('deskripsi') }}">{{ $item->deskripsi }}</textarea>
                            @error('deskripsi')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('harga_beli') is-invalid @enderror"
                                name="harga_beli" value="{{ old('harga_beli', rupiah($item->harga_beli)) }}">
                            @error('harga_beli')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('harga_jual') is-invalid @enderror"
                                name="harga_jual" value="{{ old('harga_jual', rupiah($item->harga_jual)) }}">
                            @error('harga_jual')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('stok') is-invalid @enderror" name="stok"
                                value="{{ old('stok', rupiah($item->stok)) }}">
                            @error('stok')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
